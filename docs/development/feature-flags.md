...
| `structuredWorkoutsV2` | `NEXT_PUBLIC_FEATURE_STRUCTURED_WORKOUTS_V2` | `false` | `pilot` | P05 structured-workout persistence. It has no UI in P05.C; future builder and scheduling paths require Access Control V2 server authorization and preserve the legacy builder while disabled. Rollout and rollback: [Structured workouts V2](structured-workouts-v2.md). |
