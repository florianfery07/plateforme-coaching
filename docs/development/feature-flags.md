...
| `athleteGoalsV2` | `NEXT_PUBLIC_FEATURE_ATHLETE_GOALS_V2` | `false` | `pilot` | L16c Goals V2 UI pilot; requires `accessControlV2`, a server-confirmed pilot and an explicit athlete mapping. It keeps the legacy UI active everywhere else and never dual-writes. |
