...
| `structuredWorkoutsV2` | `NEXT_PUBLIC_FEATURE_STRUCTURED_WORKOUTS_V2` | `false` | `pilot` | P05 structured-workout persistence and library builder. The V2 builder creates, reads, revisions and duplicates only V2 structures; it requires Access Control V2 server authorization and preserves the legacy builder while disabled. Rollout and rollback: [Structured workouts V2](structured-workouts-v2.md). |
