...
| `structuredWorkoutsV2` | `NEXT_PUBLIC_FEATURE_STRUCTURED_WORKOUTS_V2` | `false` | `pilot` | P05 structured-workout persistence, library builder and individual Pilotage scheduling. The V2 path atomically creates a calendar parent and independent snapshot, requires Access Control V2 server authorization, and preserves legacy models, sessions and scheduling while disabled. Groups remain deferred to P05.F. Rollout and rollback: [Structured workouts V2](structured-workouts-v2.md). |
