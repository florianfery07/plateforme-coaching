...
export default function StructuredWorkoutBuilder({ value, onChange }: { value: WorkoutStructureV2; onChange: (value: WorkoutStructureV2) => void }) {
  ...
  const renderStep = (step: AtomicStepV2, save: (next: AtomicStepV2) => void, label: string, canRemove: boolean) => <div className="grid items-end gap-2 border-t border-zinc-800 py-3 sm:grid-cols-[minmax(7rem,1fr)_6rem_6rem_auto_auto]">
