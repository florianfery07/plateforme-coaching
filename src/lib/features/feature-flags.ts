...
const publicFeatureEnvironment: FeatureFlagEnvironment = {
  ...
  NEXT_PUBLIC_FEATURE_ATHLETE_GOALS_V2:
    process.env.NEXT_PUBLIC_FEATURE_ATHLETE_GOALS_V2,
  NEXT_PUBLIC_FEATURE_ATHLETE_FEEDBACK_V2:
    process.env.NEXT_PUBLIC_FEATURE_ATHLETE_FEEDBACK_V2,
  NEXT_PUBLIC_FEATURE_COACH_PILOTAGE_V2:
    process.env.NEXT_PUBLIC_FEATURE_COACH_PILOTAGE_V2,
  NEXT_PUBLIC_FEATURE_STRUCTURED_WORKOUTS_V2:
    process.env.NEXT_PUBLIC_FEATURE_STRUCTURED_WORKOUTS_V2,
